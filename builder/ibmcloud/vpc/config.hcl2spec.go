...
type FlatConfig struct {
	...
	VSIUserDataString         *string           `mapstructure:"vsi_user_data_string" cty:"vsi_user_data_string" hcl:"vsi_user_data_string"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"vsi_user_data_string":         &hcldec.AttrSpec{Name: "vsi_user_data_string", Type: cty.String, Required: false},
